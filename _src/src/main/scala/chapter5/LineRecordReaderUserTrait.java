...
public class LineRecordReaderUserTrait extends LineRecordReader {
  ...
  // This variable is not used in ClassifyAndPredictTraitUsingDL.java
   ...
   */
  public LineRecordReaderUserTrait(List<String> labels) {
    this.labels = labels;
