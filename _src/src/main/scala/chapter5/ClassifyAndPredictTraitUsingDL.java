...
public class ClassifyAndPredictTraitUsingDL {
  ...
  public static void main(String args[]) throws IOException {
    ...
    ClassifyAndPredictTraitUsingDL dg = new ClassifyAndPredictTraitUsingDL();
  ...
  public void startTraining() {
    ...
    try (LineRecordReaderUserTrait rr = new LineRecordReaderUserTrait(LABELS)) {
      ...
      LineRecordReaderUserTrait rr1 = new LineRecordReaderUserTrait(LABELS);
  ...
  private void performTraining(int nEpochs, DataSetIterator trainIter,
