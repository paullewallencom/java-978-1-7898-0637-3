...
public class DataSetIteratorWord2Vec implements DataSetIterator {
     ...
     */
    public DataSetIteratorWord2Vec(String dataDirectory,
    ...
    public INDArray loadFeaturesFromFile(File file, int maxLength) throws IOException {
        ...
        return transformStringIntoFeatureVectorOfNumber(review, maxLength);
    }



    public INDArray transformStringIntoFeatureVectorOfNumber(String reviewContents,
                                                             int maxLength){
